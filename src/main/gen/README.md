...
libraryApp API
- API version: 1.0.0
  - Build date: 2024-07-30T07:28:16.635675607+01:00[Africa/Douala]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**createStudent**](docs/DefaultApi.md#createStudent) | **POST** /create-student | POST create-student


## Documentation for Models

 - [ResponseApi](docs/ResponseApi.md)
